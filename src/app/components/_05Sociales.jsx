  ...
  return (
    <section className={styles.sociales} id="sociales">
      ...
      >
        ...
        <p>El parque te ofrece un espacio al aire libre y natural, donde podrás respirar aire fresco y disfrutar del verde. Árboles, plantas y  luces crean un ambiente mágico, que hará que tu evento sea inolvidable y muy especial. Ademas contamos con un espacio ambientado para celebrar bodas.</p>
      </FramerReveal>
    </section>
  )
}
