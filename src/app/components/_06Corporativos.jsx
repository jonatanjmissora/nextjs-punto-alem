    ...
    <section className={styles.corporativos} id="corporativos">
      <div className={styles.wrapper}>
        ...
        >
          ...
          <p>El salón cuenta con pantallas, sonido profesional, conexión wifi y otros servicios que harán que tu evento sea de calidad. Además, tenemos  un equipo de profesionales que te asesorará y te ayudará en todo lo que necesites.</p>
        </FramerReveal>
      </div>
    </section>
  )
